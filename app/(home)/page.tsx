...
export default async function Page() {
  ...
  try {
    [homepage, projects] = await Promise.all([
      client.fetch<HomepageData | null>(homepageQuery, {}, { next: { revalidate: 60 } }),
      client.fetch<ProjectData[]>(projectsQuery, {}, { next: { revalidate: 60 } }),
    ]);
  } catch {
  ...
  return (
    <main className="min-h-screen bg-background-base flex flex-col pt-[80px] overflow-x-clip">
      ...
      <div className="relative bg-background-base" style={{ zIndex: 10000 }}>
        <Work data={homepage} projects={projects} />
