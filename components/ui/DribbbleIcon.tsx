...
/**
 * Dribbble icon — 24×24 container, icon inset 8.33% (2px each side).
 * Encoded via viewBox="-2 -2 28 28" so padding is intrinsic.
 */
export default function DribbbleIcon({ className, size = 24 }: Props) {
  return (
    <svg
      width={size}
      height={size}
