...
/**
 * Enuma case study body (everything below the hero) — shared by the standalone
 * page (`/work/enuma`) and the expand overlay, which supplies its own hero
 * (the morphing grey card).
 */
export function EnumaCaseStudyBody() {
  return (
    <>
      {/* ── Stats strip ─────────────────────────────────────────────────────── */}
      ...
      <section className="px-6 py-8 md:px-10 md:py-12 lg:px-s lg:py-l xl:px-xl 2xl:px-xl w-full max-w-[1440px] mx-auto grid grid-cols-12 gap-4 md:gap-6 lg:gap-10">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              <span className="py-0.5 px-1">Visit enuma-collective.com</span>
            </a>
...
/**
 * Full Enuma case study with its own illustration hero — used by the standalone
 * page `/work/enuma` (direct navigation, no morph).
 */
export default function EnumaCaseStudy() {
  return (
    <>
      <section
      ...
      >
        ...
        <motion.div
          ...
          transition={{ duration: 1.2, ease }}
        >
          <Image src="/img/work/enuma_logo.svg" alt="Enuma Collective" width={120} height={24} className="opacity-60" unoptimized />
          <h1 className="font-display text-2xl max-w-[720px] whitespace-pre-line" style={gradientText}>
          ...
          <div className="flex flex-wrap gap-3">
            <a href="https://www.enuma-collective.com" target="_blank" rel="noopener noreferrer" className={buttonVariants({ variant: "primary", size: "lg" })}>
              <span className="py-0.5 px-1">Visit enuma-collective.com</span>
            </a>
          </div>
        </motion.div>
